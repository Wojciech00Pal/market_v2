    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Beverage-t", "Beverage" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "CategoryId", "Description", "Name" },
                values: new object[] { 2, "Cola", "Frozen" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "CategoryId", "Description", "Name" },
                values: new object[] { 3, "Meat-t", "Meat" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Iced tea", 2.9700000000000002, 100 },
                    { 2, 1, "tea", 5.0, 60 },
                    { 3, 1, "Orange", 2.9900000000000002, 1000 },
                    { 4, 3, "Chicken", 2.8999999999999999, 100 }
                });
